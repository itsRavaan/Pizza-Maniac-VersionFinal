...
export class CartService {
  ...
  //Function to get products which returns a pizza array
  getAllProducts() {
      /*
      ...
      */
      ...
      return this.http.get<pizza[]>(this.apiUrl + 'pizza').pipe(
        map(products => {
  ...
  addItem(product:pizza)
  {
    ...
    if(exist)
    {
      ...
      //Display error toast
      this.toastr.error(exist.pizzaName + ' already in cart!');
    }
    ...
    else
    {
      ...
      if(ls)
      {
        ...
        this.toastr.success(product.pizzaName + ' added to cart!');
  ...
  removeCartItem(id: number): void {
    ...
    {
      //Display toast
      this.toastr.error( 'Error Occured when trying to delete ' + toDelete.pizzaName );
    }
    ...
    //Display toast
    this.toastr.success( toDelete.pizzaName + ' Removed Successfully');
  ...
  makePurchase() {
    ...
    //Make http post
    this.http.post(this.apiUrl + 'AppUserOrder', ls)
        .subscribe(
